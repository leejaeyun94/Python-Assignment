...
def merge_image():
    ...
    for idx, img in enumerate(images):
        ...
        progress_bar.update()
    #포멧 옵션 처리
    file_name = "yun_photo." + img_format
...
btn_dest_path = Button(path_frame, text="찾아보기", width=10, command = browse_dset_path)
